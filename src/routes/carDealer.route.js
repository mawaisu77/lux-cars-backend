...
const { registerCarDealer, updateCarDealer, getDealerByUserID, getDealerDataByUserID} = require("../controllers/carDealers.controller.js");
...
router.get('/car-dealer/get-car-dealer-data', getDealerDataByUserID)
